        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div className="grid grid-cols-2 gap-3">
            <div>
              ...
              <input type="text" required value={form.firstName} onChange={set('firstName')} placeholder="Sione" className="input" />
            </div>
            <div>
              <label className="label">Last name</label>
              <input type="text" required value={form.lastName} onChange={set('lastName')} placeholder="Taufa" className="input" />
            </div>
          </div>
          <div>
          ...
          <div>
            ...
            <input type="tel" value={form.phone} onChange={set('phone')} placeholder="+679 9123456" className="input" />
          </div>
          <div>
            <label className="label">Password</label>
            <div className="relative">
              <input type={showPw ? 'text' : 'password'} required value={form.password}
                onChange={set('password')} placeholder="Min. 8 characters" className="input pr-10" minLength={8} />
          ...
          <p className="text-xs text-slate/40 text-center leading-relaxed">
            By registering you agree to our <Link href="/terms" className="underline underline-offset-2 text-ocean">Terms of Service</Link> and <Link href="/privacy" className="underline underline-offset-2 text-ocean">Privacy Policy</Link>.
          </p>
        </form>
        <p className="text-center text-sm text-slate/50 mt-6">
          Already have an account?{' '}
          <Link href="/login" className="text-ocean font-medium hover:underline underline-offset-2">Sign in</Link>
        </p>
      </div>
    </div>
  );
