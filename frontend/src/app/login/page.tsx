      ...
      <div className="flex-1 flex items-center justify-center px-4 py-16">
        <div className="w-full max-w-sm">
          ...
          <div className="bg-ocean/5 border border-ocean/20 rounded-xl p-4 mb-6 text-xs text-slate/60 space-y-1">
            ...
            <p>Admin: <span className="font-mono text-ocean">admin@fijistays.com.fj</span> / <span className="font-mono">Admin1234!</span></p>
          </div>
          ...
          <p className="text-center text-sm text-slate/50 mt-6">
            ...
            <Link href="/register" className="text-ocean font-medium hover:underline underline-offset-2">
              Get started free
            </Link>
          </p>
        </div>
      ...
      <div className="hidden lg:block flex-1 relative overflow-hidden">
        ...
        <div className="absolute bottom-12 left-12 right-12">
          <blockquote className="font-display text-2xl text-white leading-snug mb-4">
            "The most authentic experience of my life — Navala village showed me the real Fiji."
          </blockquote>
          <div className="flex items-center gap-3">
            <div className="w-10 h-10 rounded-full bg-sand/30 flex items-center justify-center text-white font-medium">SJ</div>
            <div>
              <p className="text-white font-medium text-sm">Sarah Johnson</p>
              <p className="text-white/60 text-xs">Traveller from Melbourne, Australia</p>
            </div>
          </div>
        </div>
      </div>
